...
export default function ConglomerationPreviewPage() {
  return (
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="max-w-[600px]">
              ...
              <h1 className="mt-4 font-[family-name:var(--font-noto)] text-[34px] leading-[1.08] text-stone-900 lg:text-[56px]">
                This reporting system preview is currently off the map.
              </h1>
              <p className="mt-5 max-w-[540px] font-[family-name:var(--font-noto)] text-[15px] leading-8 text-stone-600 lg:text-[17px]">
                The live Conglomeration Reporting System preview is unavailable at the moment, so this page acts as a designed 404 destination inside the portfolio.
            ...
            <div className="mt-10 grid max-w-[600px] gap-4 sm:grid-cols-3">
              {[
                ...
                { label: "Project", value: "Reporting System" },
