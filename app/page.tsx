  ...
  return (
    <div className="relative" style={{ overflowX: "clip" }}>
      ...
      <CursorHint label="Hover on items" delay={5} duration={5}>
        <div className="hidden lg:flex min-h-screen items-center justify-center px-4 relative z-10">
          <div ref={heroRef} className="relative w-[1400px] h-[900px] overflow-visible" style={{ maxWidth: "100vw", transform: "translateX(-25px)" }}>
            ...
            {/* Image collage */}
            <a href="https://unsplash.com/@ripaahyar" target="_blank" rel="noopener noreferrer" className="hidden lg:block absolute right-[-30px] top-[200px] z-10 rotate-[6deg] transition-transform duration-300 ease-out hover:rotate-[2deg] hover:scale-105 cursor-pointer group/collage overflow-visible hero-entrance"
      ...
      >
        ...
        {/* Unsplash */}
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://unsplash.com/@ripaahyar" target="_blank" rel="noopener noreferrer" className="relative font-[family-name:var(--font-noto)] text-[14px] text-stone-500 flex items-center justify-center social-morph">
        ...
        <nav className="flex flex-wrap justify-center gap-3 mb-16">
          {tabs.map((tab, i) => (
            <button
              ...
              className={`px-5 py-2 rounded-full font-mono text-xs transition-all ${i === activeTab
